...
class FireFighter:
    ...
    def __init__(self, display, name, pos, size, volume):
        ...
        self.put_out_fire_audio.set_volume(volume * 0.3)
        self.rescue_monkey_audio = pygame.mixer.Sound("audios/SFX/firefighter/RescueMonkey.wav")
        self.rescue_monkey_audio.set_volume(volume)
        self.rescue_civilian_audio = pygame.mixer.Sound("audios/SFX/firefighter/RescueCivilian.wav")
        self.rescue_civilian_audio.set_volume(volume)
        self.refil_water_tank_audio = pygame.mixer.Sound("audios/SFX/firefighter/RefilWaterTank.wav")
        self.refil_water_tank_audio.set_volume(volume * 1.3)
        self.got_point_audio = pygame.mixer.Sound("audios/SFX/UI/GotPoint.wav")
